...
import time
from BGameImproved import generateMove, getImprovedStatEstForMidgameEndgame
...
if __name__ == "__main__":
    ...
    staticEstCounter = [0]   
    res = abMaxMin(swappedIB,-float('inf'),float('inf'),height,0,getImprovedStatEstForOpen,generateMovesOpening,staticEstCounter,starttime,40,openingMoveLeft)  
